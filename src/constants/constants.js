export const projects = [
  ...
  {
    title:
      "Adversarial State Space Search Game with MiniMax Heurisitc (TicTacToe AI)",
    description:
    ...
    image:
      "/images/Optimized-Illustration-from-Adobe-Stock-for-ITC-Post-on-AI-in-Game-Development-scaled.jpeg",
    tags: ["Java"],
